    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="课程价格">
          <a-input-number v-decorator="[ 'chinaPrice', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="hkPrice">
          <a-input-number v-decorator="[ 'hkPrice', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="几节课">
          <a-input-number v-decorator="[ 'numCourse', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="一节课几天">
          <a-input-number v-decorator="[ 'dayCourse', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="课程类型">
          <a-input placeholder="请输入课程类型" v-decorator="['courseType', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="课程人数">
          <a-input-number v-decorator="[ 'enterNum', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'courseName','comment','chinaPrice','hkPrice','num','address','language','intro','courseContent','pictureUrl','videoUrl','courseVerify','courseRefund','achieve','level','numCourse','dayCourse','courseType','enterNum'))
		  //时间格式化
