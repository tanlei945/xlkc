      ...
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="收货人姓名">
              <a-input placeholder="请输入收货人姓名" v-model="queryParam.name"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
        ...
        <a-col :md="6" :sm="8">
            <a-form-item label="收货地址">
              <a-input placeholder="请输入收货地址" v-model="queryParam.address"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="0/不是默认 1/默认地址">
              <a-input placeholder="请输入0/不是默认 1/默认地址" v-model="queryParam.state"></a-input>
            </a-form-item>
          </a-col>
        </template>
          <a-col :md="6" :sm="8" >
