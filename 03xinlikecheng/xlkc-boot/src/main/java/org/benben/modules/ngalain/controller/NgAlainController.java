package org.benben.modules.ngalain.controller;

import com.alibaba.fastjson.JSONObject;
import lombok.extern.slf4j.Slf4j;
import org.apache.shiro.SecurityUtils;
import org.benben.common.api.vo.Result;
import org.benben.modules.ngalain.service.NgAlainService;
...
public class NgAlainController {
    ...
    public JSONObject getAppData(HttpServletRequest request) throws Exception {
       String token=request.getHeader("X-Access-Token");
        ...
        app.put("name", "benben-boot-angular");
        app.put("description", "benben+ng-alain整合版本");
        j.put("app", app);
        return j;
    }
