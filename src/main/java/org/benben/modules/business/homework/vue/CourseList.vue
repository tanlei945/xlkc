  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/homework/course/list",
          delete: "/homework/course/delete",
          deleteBatch: "/homework/course/deleteBatch",
          exportXlsUrl: "homework/course/exportXls",
          importExcelUrl: "homework/course/importExcel",
       },
    }
  },
  computed: {
