      ...
      <a-form layout="inline">
        ...
        <a-col :md="6" :sm="8">
            <a-form-item label="课程价格">
              <a-input placeholder="请输入课程价格" v-model="queryParam.chinaPrice"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="hkPrice">
              <a-input placeholder="请输入hkPrice" v-model="queryParam.hkPrice"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
    ...
    data () {
      return {
		...
		url: {
          ...
          deleteBatch: "/course/course/deleteBatch",
          exportXlsUrl: "course/course/exportXls",
          importExcelUrl: "course/course/importExcel",
       },
    }
  },
  computed: {
