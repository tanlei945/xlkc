...
# 
api_key="6f800bdabb7f8600621f382e9c55a0001890349354" 			#api_key
api_token="4488052ca6e19df36fa14b8ca33cf0ee596841824" 	#api_token
url="http://doc.zzzlink.com/server/?s=/api/open/fromComments" #同步到的url。使用www.showdoc.cc的不需要修改，使用开源版的请修改
#
#
#
#
