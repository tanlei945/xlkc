package org.benben.common.XXPay;
...
public class PayCommonUtil {
	//微信参数配置
	public static String API_KEY = "xlkc012345678901xlkc012345678901";
	public static String APPID = "wx29264b38531d6be5";
	public static String MCH_ID = "1541268841";
...
//		parameterMap.put("attach", attach);
		...
		parameterMap.put("spbill_create_ip","47.106.98.95");
	...
	public static String httpsRequest2(String requestUrl, String requestMethod, String outputStr) throws Exception {
		...
		try (CloseableHttpClient httpclient = HttpClients.custom()
			...
			httpost.addHeader("UserPostsVos-Agent", "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.0) ");
